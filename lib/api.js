...
// Always call the Java service through Next.js rewrites so the browser
// talks only to the Next.js origin, and Next proxies to the backend.
// See `next.config.js` rewrites: `/api/:path* -> http://localhost:8079/v1/:path*` (or BACKEND_URL).
