...
/** Register client-side navigation for session expiry (avoids full page reload). */
export function setRedirectToLoginHandler(handler) {
  redirectToLoginHandler = handler;
}

/**
 * Remove token and user from storage. Optionally send user to login.
 */
